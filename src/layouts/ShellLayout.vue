...
<template>
  <div class="h-screen w-screen bg-[var(--dash-bg)] text-[var(--dash-text)] flex flex-col overflow-hidden">
    ...
    <router-link
      ...
      to="/settings"
      class="fixed bottom-6 right-6 z-40 p-3 rounded-full bg-white/10 text-[var(--dash-text-muted)] hover:text-[var(--dash-text)] hover:bg-white/20 transition-all backdrop-blur-sm border border-white/5 shadow-lg active:scale-90"
      title="Settings"
    >
